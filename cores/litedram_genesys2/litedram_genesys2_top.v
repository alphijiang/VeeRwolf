...
// Thin Genesys 2 wrapper around an upstream-generated LiteDRAM core.

`timescale 1ps / 1ps
`default_nettype none

module litedram_genesys2_top
  #(parameter ID_WIDTH = 0)
   ...
   // Keep the same wrapper behavior as upstream VeeRwolf LiteDRAM: only UART
   // and init status are registered here.  AXI handshakes pass straight to the
   // generated core; block_until_ready remains owned by LiteDRAM itself.
